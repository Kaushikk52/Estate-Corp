...
public class SecurityConfig {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,
                                "/v1/api/properties/post").authenticated()
                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173","https://estate-corp.netlify.app","https://development--estate-corp.netlify.app")); // Adjust allowed origins as needed
